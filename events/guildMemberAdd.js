...
module.exports = async (client, member) => {
  ...
  const rs = "• 2,702/2,938 achievements or 26,445/28,745 RuneScore";
  const amReq = client.amReq.get("0");
  const wMsg = `\n\nIf you have any of the following, please let us know here and we will assign the correct roles to signify:\n• Max | Comp | MQC | Comp (t) Cape\n• Insane Final Boss, Ultimate Slayer, or Master of All titles\n• ${amReq}\n• Max Total Virtual Level or Max Experience\n• A HCIM or IM Account you actively play on\n• You are a RS Twitch streamer or YouTuber with 100 or more followers\n\nIf you need help or a community in game, you are welcome to guest in our clan: **'Alright'** on World 68 and join our Friends Chat **'AHelp'**\n\nThanks for joining us! (:\n▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬`;
  const maxUsers = "5";
...
*/
  const welcome = async () => {
    ...
    const userArrOld = userArr;
    const userIDsOld = userIDs;
    userArr = "";
    userIDs = [];
    ...
    const userList = userArrOld.join(", ");
