exports.data = {
  ...
  "77 - 96 pt2": {
    ...
    "fields": [
      ...
      {
        "name": "​",
        "value": "To attract draconic jadinkos players must have at least level 61 Farming to plant a [red blossom seed](http://runescape.wikia.com/wiki/Red_blossom_seed) and [lergberry seed](http://runescape.wikia.com/wiki/Lergberry_seed) in the vine blossom and vine bush patches. Players must also build a [dark pit](http://runescape.wikia.com/wiki/Dark_pit) habitat at the environmental feature patch. The player will additionally need to use a dose of a [juju hunter potion](http://runescape.wikia.com/wiki/Juju_hunter_potion) to their red vine blossom and will need to reapply a dose to their vine blossom patch every 10 minutes while hunting draconic jadinkos. Juju hunter potions are tradable and can be bought from the Grand Exchange."
      },
      {
        "name": "Alternative Method: Levels 88-89",
        "value": "With level 88 Hunter the player can begin to hunt [Charming Moths](http://runescape.wikia.com/wiki/Charming_moth). They are caught barehanded and level 83 Agility is also required to catch them. At level 99 Hunter a player can gain around 230,000 Hunter experience and 45,000 Agility experience an hour from hunting charming moths. As charming moths are located in the [Wilderness](http://runescape.wikia.com/wiki/Wilderness), near [Daemonheim](http://runescape.wikia.com/wiki/Daemonheim), it is possible to be attacked by other players whilst training at them."
      },
         {
        "name": "​",
      ...
      },
      {
        ...
        "value": "From level 89 players can catch [Crimson Skillchompas](http://runescape.wikia.com/wiki/Crimson_skillchompa_(Hunter) using box traps. Up to 4 skillchompas can be caught per trap, which scales with Agility level. From level 94 Agility, multiple are always caught. Players can gain around 420,000 experience an hour hunting crimson skillchompas with level 99 Hunter and Agility. These skillchompas can be caught at the [Desert Quarry Hunter area](http://runescape.wikia.com/wiki/Desert_Quarry_Hunter_area), which is found south of the [Desert Quarry](http://runescape.wikia.com/wiki/Desert_Quarry). Players will gain at least one stackable crimson skillchompa each time that one of these creatures is successfully caught."
      },
      {
        "name": "​",
  ...
  "alternative methods": {
    ...
    "url": "http://runescape.wikia.com/wiki/Hunter_training#Alternative_methods_of_gaining_experience",
  ...
  "pet - ace": {
    ...
    "description": "Ace is an item that can be found while training Hunter. It can be used to unlock the [Ace pet](http://runescape.wikia.com/wiki/Ace).",
    "url": "http://runescape.wikia.com/wiki/Ace_pet",
    "color": 12269891,
    "footer": {
      "icon_url": "https://cdn.discordapp.com/attachments/297388220231057419/400471386101121024/image.jpg",
      "text": "Achievement Help | Helping you reach your goals, whatever they may be!"
  ...
  "quests": {
    ...
    "url": "http://runescape.wikia.com/wiki/Quests/Experience_rewards#Hunter",
    ...
    "fields": [
      {
        ...
        "value": "The full list may be found [here](http://runescape.wikia.com/wiki/Quests/Experience_rewards#Hunter)."
      }
      ]
  },
  ...
  "daily challenge":  {
    ...
    "fields": [
      {
        "name": "​",
        "value": "At level 99, 47,200 experience is awarded per day for catching:\n\n• 40 [Jadinkos](http://runescape.wikia.com/wiki/Jadinko) \n\nDaily challenges may be extended for 50 [Vis Wax](http://runescape.wikia.com/wiki/Vis_wax) for double the reward.\n\nA full chart of the experience per level for the daily challenge may be found [here](http://runescape.wikia.com/wiki/Challenge_System/Hunter)."
      }
      ]
  },
  "permanent boosts": {
    ...
    "fields": [
      ...
      },
      {
        ...
        "value": "•  [Witchdoctor Camouflage Gear](http://runescape.wikia.com/wiki/Witchdoctor_camouflage_gear) pieces are awarded from [Papa Mambo](http://runescape.wikia.com/wiki/Papa_Mambo). Wearing the camouflage set improves the player's chance of catching jadinkos while hunting at [Herblore Habitat](http://runescape.wikia.com/wiki/Herblore_Habitat)."
      },
      {
        "name": "Trapper Outfits",
        "value": "• [Elite Skilling Outfit](http://runescape.wikia.com/wiki/Experience-boosting_set#Elite_skilling_outfits)- [Desert](http://runescape.wikia.com/wiki/Desert_trapper_outfit), [Jungle](http://runescape.wikia.com/wiki/Jungle_trapper_outfit), [Arctic](http://runescape.wikia.com/wiki/Arctic_trapper_outfit)\n\t• 3 daily teleports to various hunter locations\n\t• 5% increase success chance while Hunting (stacks with [Tracker auras](http://runescape.wikia.com/wiki/Tracker_aura))\n\t• Increased chance of rarer charm sprites from Yaktwee\n\t• Auto-reapplies Juju hunter potion in Herblore Habitat\n\t• Uses Hunter's outfit's bonus experience if owned"
      },
      {
        "name": "Combined Trapper Outfit",
        "value": "• [Volcanic Trapper Outfit](http://runescape.wikia.com/wiki/Volcanic_trapper_outfit)\n\t• 5 daily teleports to various hunter locations\n\t• 7% increase success chance while Hunting (stacks with [Tracker auras](http://runescape.wikia.com/wiki/Tracker_aura))\n\t• Increased chance of rarer charm sprites from Yaktwee\n\t• Auto-reapplies Juju hunter potion in Herblore Habitat\n\t• Uses Hunter's outfit's bonus experience if owned\n\t• 10% chance of double loot\n\t• Chance of double loot from [Implings](http://runescape.wikia.com/wiki/Impling) (3 per day)\n\t• Increased conversion rate for [Big Chinchompa](http://runescape.wikia.com/wiki/Big_Chinchompa) reward points\n\t• Can deploy an extra trap (maximum of 6)\n\t• Chance to instantly deploy/pick up traps\n\t•Works as a [Hunter's Catalyst fragment](http://runescape.wikia.com/wiki/Hunter%27s_Catalyst_fragment) if owned."
      }
      ]
  },
  "temporary boosts": {
    ...
    "fields": [
      ...
      {
        "name": "​",
        "value": "Spirit [Kyatt](http://runescape.wikia.com/wiki/Spirit_kyatt), [Larupia](http://runescape.wikia.com/wiki/Spirit_larupia), and [Graahk](http://runescape.wikia.com/wiki/Spirit_graahk)\n• +5 invisible levels\n• Requires 57 Summoning\n\n[Urns](http://runescape.wikia.com/wiki/Urns#Hunter.28m.29)\n• +220-1600 Experience per urn (depends on level of urn used)\n•  +275-2000 if used with [Urn Enhancer](http://runescape.wikia.com/wiki/Urn_enhancer)\n\n[Tracker Auras](http://runescape.wikia.com/wiki/Tracker_aura)\n• Tracker auras increase your chances of success by at least 3%-15% depending on the tier a player owns. Players may use 20 or 40 [Vis Wax](http://runescape.wikia.com/wiki/Vis_wax) to extend a tracker aura's activation time by 50% or 100%. This effect must be applied before the aura is activated. Tracker auras can be bought using [Membership Loyalty Points](http://runescape.wikia.com/wiki/Members_Loyalty_Programme). The lower tier aura must be owned before the greater version of the aura can be purchased."
      },
      {
        "name": "​",
