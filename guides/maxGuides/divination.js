exports.data = {
  ...
  "20 - 30": {
    ...
    "description": "With at least level 20 Divination players can move to the [Bright Wisp Colony](http://runescape.wikia.com/wiki/Bright_wisp), which is found east of Varrock, west of the Digsite. When buying additional energy, players can gain around 13,000 experience an hour from training at bright wisps, or 11,000 experience an hour if not buying additional energy.",
  ...
  "70 - 80": {
    ...
    "url": "http://runescape.wikia.com/wiki/Divination_training#Elder_wisps_or_lustrous_wisps_.28levels_75.E2.80.9380.29",
    "description": "​",
        "color": 12269891,
    "footer": {
      "icon_url": "https://cdn.discordapp.com/attachments/297388220231057419/400471386101121024/image.jpg",
    ...
    "fields": [
      {
        ...
        "value": "At level 95 Divination, players who have access to [Uncharted Isles](http://runescape.wikia.com/wiki/Uncharted_Isles) in [The Arc](http://runescape.wikia.com/wiki/The_Arc) can train on ancestral energy. Players must find dead moai on the island which are leaking ancestral energy and collect it. The energy is collected but no memories are produced or deposited, meaning all the experience comes directly from the gathering. With this in mind, no energy must be purchased or gathered to increase the experience per hour. This method gives approximately 107,000 experience per hour.\n\nThe experience from harvesting ancestral energy can further be bolstered by completing contracts given by [Sojobo (contracts)](http://runescape.wikia.com/wiki/The_Tengu) on Waiko or via a contract contact on an uncharted isle. Divination contracts for ancestral energy give up to about 35,000 experience when handed in, though they tend to average about 24,000 experience each."
      },
      {
  ...
  "alternative methods": {
    ...
    "url": "http://runescape.wikia.com/wiki/Divination_training#Alternative_methods_of_gaining_experience",
  ...
  "pet - willow": {
    ...
    "description": "Willow is the skilling pet obtainable from Divination. It is unlocked by using the [Willow pet](http://runescape.wikia.com/wiki/Willow_pet) item.",
    "url": "http://runescape.wikia.com/wiki/Willow_(pet)",
    "color": 12269891,
    "footer": {
      "icon_url": "https://cdn.discordapp.com/attachments/297388220231057419/400471386101121024/image.jpg",
      "text": "Achievement Help | Divination"
    ...
    "fields": [
      {
        ...
        "value": "The full list may be found [here](http://runescape.wikia.com/wiki/Quests/Experience_rewards#Divination)."
      }
      ]
  },
  "distractions and diversions": { 
    ...
    "value": "[Memorial to Guthix](http://runescape.wikia.com/wiki/Memorial_to_Guthix#Benefits) is a Divination Distraction and Diversion revolving around the late god [Guthix](http://runescape.wikia.com/wiki/Guthix). The memorial site is located in the [Piscatoris Hunter area](http://runescape.wikia.com/wiki/Piscatoris_Hunter_area), just north of the ferrets and [Nickolaus's](http://runescape.wikia.com/wiki/Nickolaus) camp and just south of the [Phoenix Lair](http://runescape.wikia.com/wiki/Phoenix_Lair) and the [Airut](http://runescape.wikia.com/wiki/Airut). Players can also teleport directly to the shrine through the use of [memory strands](http://runescape.wikia.com/wiki/Memory_strand), [Sixth-Age circuit](http://runescape.wikia.com/wiki/Sixth-Age_circuit) or charged [engrams](http://runescape.wikia.com/wiki/Engram)." 
    }, 
    { 
    "name": "​", 
    "value": "While training Divination outside of Dungeoneering, memory strands can be collected and stored in the [currency pouch](http://runescape.wikia.com/wiki/Currency_pouch). The strands are stored automatically after adding the strands to the currency pouch for the first time. These strands can be combined with engrams which can be found all around Gielinor to create echoes. For a list of locations, click [here](http://runescape.wikia.com/wiki/Memorial_to_Guthix#Locations_and_buffs)." 
    },
    { 
    "name": "​", 
    "value": "Upon unlocking echoes players gain 17,192 Divination experience for each and unlock one of twelve buffs. Initially they're able to activate one and change it with the weekly reset, after adding an echo for the first time or rising up in prestige. After adding all echoes players can reset their progress by right clicking the [fountain of energy](http://runescape.wikia.com/wiki/Fountain_of_energy) and selecting prestige, rising up in prestige and starting over. By doing this, they can activate progressively more buffs. A player may only have up to 5 buffs active at once even if they continue to prestige past the fourth prestige. All the buffs remain unlocked even after the player has reset their progress, any buffs active at the time of prestige will remain active." 
    } 
    ] 
  },
	"daily challenge": {
