exports.data = {
  ...
  "1 - 15":  {
    ...
    "fields": [
      ...
      { 
        ...
        "value": "If the player cannot afford to buy ores off the Grand Exchange, they can mine their own. Copper and tin ores can be found in the [Burthorpe mine](http://runescape.wikia.com/wiki/Burthorpe_mine), the [Dwarvern mine](http://runescape.wikia.com/wiki/Dwarven_Mine) north of [Falador](http://runescape.wikia.com/wiki/Falador), [South-east of Varrock](http://runescape.wikia.com/wiki/South-east_Varrock_mining_site) and in the [Lumbridge swamp](http://runescape.wikia.com/wiki/Lumbridge_Swamp_training_mining_site).\n\nIf using this method, the player can choose to either sell the bronze bars made (this is better profit) or smith the bars into equipment which can be sold (better experience)."
      }
      ]
  },
  "15 - 30": {
    ...
    "fields": [
      ...
      { 
        "name": "▬▬ Alternative Method: No Investment ▬▬",
        "value": "If the player cannot afford to buy ores off the Grand Exchange, they can mine their own. Iron ore can be found all around RuneScape; a full list can be found [here](http://runescape.wikia.com/wiki/Iron_ore_rocks#Locations).\n\nIf using this method, the player can choose to either sell the bronze bars made (this is better profit) or smith the bars into equipment which can be sold (better experience)."
      },
      { 
        "name": "▬▬ Alternative Method: The Knight's Sword ▬▬",
        "value": "[The Knight's Sword](http://runescape.wikia.com/wiki/The_Knight%27s_Sword) quest can be completed at any smithing level, but the reward lamp requires level 28 smithing to use. Redeeming it, however, will instantly give enough experience to reach level 35."
      }
      ]
  },
  "30 - 45": {
    "title": "Smithing Training Levels 30-45",
    "description": "At level 30, players can smelt [steel bars](http://runescape.wikia.com/wiki/Steel_bar) from one [iron ore](http://runescape.wikia.com/wiki/Iron_ore) and two [coal](http://runescape.wikia.com/wiki/Coal). The fastest experience is to buy the ore from the [Grand Exchange](http://runescape.wikia.com/wiki/Grand_Exchange). Using a [furnace](http://runescape.wikia.com/wiki/Furnace) or [portable forge](http://runescape.wikia.com/wiki/Portable_forge), smelt the ores into steel bars and then sell these back on the Grand Exchange. The closest furnaces to a bank are in [Edgeville](http://runescape.wikia.com/wiki/Edgeville) and the [Lumbridge Combat Academy](http://runescape.wikia.com/wiki/Combat_Academy).\n\nThis method requires an initial investment of around 4,000 gold pieces, but will make a profit.",
    "url": "http://runescape.wikia.com/wiki/Steel_bar",
    "color": 12269891,
    "footer": {
      "icon_url": "https://cdn.discordapp.com/attachments/297388220231057419/400471386101121024/image.jpg",
      "text": "Achievement Help | Helping you reach your goals, whatever they may be!"
  ...
  "70 - 88": {
    ...
    "fields": [
      ...
      { 
        ...
        "value": "The player can smelt [gold ore](http://runescape.wikia.com/wiki/Gold_ore) into [gold bars](http://runescape.wikia.com/wiki/Gold_bar). The player can choose to mine the ore themselves (higher profit) or buy it off the Grand Exchange (faster experience). After completeing the [Family Crest](http://runescape.wikia.com/wiki/Family_Crest) quest, players can use the [goldsmithing gauntlets](http://runescape.wikia.com/wiki/Goldsmith_gauntlets) to increase the experience gained when smelthing gold ore from 22.5 to 56.2. Using this boost, smelting gold is a viable, low-cost method up to level 99 with a rate of around 68,000 experience per hour"
      },
      { 
  ...
  "88 - 99 +": {
    ...
    "fields": [
      ...
      { 
        "name": "▬▬ Alternative Method: Faster Experience ▬▬",
        "value": "Smithing [adamant platebodies](http://runescape.wikia.com/wiki/Adamant_platebody) near to a bank using [presets](http://runescape.wikia.com/wiki/Bank_preset) and a [beast of burden](http://runescape.wikia.com/wiki/Beast_of_Burden) can provide a rate of around 360,000 experience per hour. It takes 27,676 platebodies to reach level 99."
      },
      { 
        "name": "▬▬ Alternative Method: Profitable ▬▬",
        "value": "The player can smelt [gold ore](http://runescape.wikia.com/wiki/Gold_ore) into [gold bars](http://runescape.wikia.com/wiki/Gold_bar). The player can choose to mine the ore themselves (higher profit) or buy it off the Grand Exchange (faster experience). After completeing the [Family Crest](http://runescape.wikia.com/wiki/Family_Crest) quest, players can use the [goldsmithing gauntlets](http://runescape.wikia.com/wiki/Goldsmith_gauntlets) to increase the experience gained when smelthing gold ore from 22.5 to 56.2. Using this boost, smelting gold is a viable, low-cost method up to level 99 with a rate of around 68,000 experience per hour"
  ...
  "alternative methods": {
    ...
    "url": "http://runescape.wikia.com/wiki/Pay-to-play_Smithing_training#Free_alternatives",
  ...
  "quests": {
    ...
    "url": "http://runescape.wikia.com/wiki/Quests/Experience_rewards#Smithing",
    ...
    "fields": [
      {
        ...
        "value": "The full list may be found [here](http://runescape.wikia.com/wiki/Quests/Experience_rewards#Smithing)."
      }
      ]
  },
  ...
  "daily challenge": {
    ...
    "fields": [
      {
        "name": "​",
        "value": "At level 98, 22,153.5 experience is awarded per day for completing:\n\n• Smithing 16 [mithril ceremonial swords](http://runescape.wikia.com/wiki/Mithril_ceremonial_sword)\n\nDaily challenges may be extended for 50 [Vis Wax](http://runescape.wikia.com/wiki/Vis_wax) for double the reward.\n\nA full chart of the experience per level for the daily challenge may be found [here](http://runescape.wikia.com/wiki/Challenge_System/Smithing)."
      }
      ]
  },
  "permanent boosts pt1": {
    ...
    "fields": [
      {
        "name": "Smithing Cape",
        "value": "• The [Smithing Cape's](http://runescape.wikia.com/wiki/Smithing_cape) perk provides the effect of having the [goldsmith gauntlets](http://runescape.wikia.com/wiki/Goldsmith_gauntlets) equipped, which increase experience for smithing [gold bars](http://runescape.wikia.com/wiki/Gold_bar) from 22.5 to 56.2."
      },
      {
        "name": "Blacksmith's Outfit",
        "value": "• Wearing components of the [Blacksmith's Outfit](http://runescape.wikia.com/wiki/Blacksmith%27s_outfit) gives a percentage increase in the amount of Smithing experience gained. There are five pieces in the set: the headwear, chestpiece, legwear, gloves and boots. Components of the blacksmith's outfit can be obtained from [Treasure Hunter](http://runescape.wikia.com/wiki/Treasure_Hunter) or as a reward whilst smithing [ceremonial swords](http://runescape.wikia.com/wiki/Ceremonial_sword) at the [Artisan's Workshop](http://runescape.wikia.com/wiki/Artisans_Workshop).\n\nEach piece provides 1% additional thieving experience when worn. If all pieces of the set are worn, an additional set bonus effect of 1% is given, for a total of 6%. The chestpiece will provide the benefits of the [Varrock armour](http://runescape.wikia.com/wiki/Varrock_armour_4), if owned, but the legs will not provide the bonus of the [Morytania legs 2](http://runescape.wikia.com/wiki/Morytania_legs_2)."
      },
      {
        "name": "Varrock Armour",
        "value": "• The [Varrock armour](http://runescape.wikia.com/wiki/Varrock_armour_4) is obtained by completing the [Varrock achievements](http://runescape.wikia.com/wiki/Varrock_achievements). Each tier has Smithing benefits, a complete list of which can be found [here](http://runescape.wikia.com/wiki/Varrock_armour_4).\n\nCompleting the [New Varrock achievements](http://runescape.wikia.com/wiki/New_Varrock_achievements) after the [Dimension of Disaster](http://runescape.wikia.com/wiki/Dimension_of_Disaster) quest gives additional benefits to the armour. A list can be found [here](http://runescape.wikia.com/wiki/Varrock_armour_4)."
      },
      {
        "name": "Morytania Legs",
        "value": "• The [Morytania legs 2](http://runescape.wikia.com/wiki/Morytania_legs_2) are a reward for completing the [medium Morytania achievements](http://runescape.wikia.com/wiki/Morytania_achievements#Medium_tasks). They allow the player to smith [cannonballs](http://runescape.wikia.com/wiki/Cannonball) twice as fast at the furnace in [Port Phasmatys](http://runescape.wikia.com/wiki/Port_Phasmatys)."
      },
      {
        "name": "Goldsmith Gauntlets",
        "value": "• The [goldsmith gauntlets](http://runescape.wikia.com/wiki/Goldsmith_gauntlets) increase the experience for smithing [gold bars](http://runescape.wikia.com/wiki/Gold_bar) from 22.5 to 56.2 when worn."
      },
      {
