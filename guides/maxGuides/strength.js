exports.data = {
  ...
  "1 - 40": {
    ...
    "description": "From levels 1-40 players can begin training Strength on [Troll Chuckers](http://runescape.wikia.com/wiki/Troll_chucker). The trolls are level 1, with only 50 life points. They can be found in the northern section of the [Abandoned Burthorpe mine](http://runescape.wikia.com/wiki/Abandoned_Burthorpe_mine), north of [Burthorpe](http://runescape.wikia.com/wiki/Burthorpe).",
    ...
    "author": {
     ...
     },
     {
       ...
       "value":"• 1-10 [Bronze](http://runescape.wikia.com/wiki/Bronze_equipment#Melee_weapons)\n\nUpgrade:\n• 10-20 [Iron](http://runescape.wikia.com/wiki/Iron_equipment#Melee_weapons) (Requires 10 Attack)\n\nUpgrade:\n• 20-30 [Steel](http://runescape.wikia.com/wiki/Steel_equipment#Melee_weapons) (Requires 20 Attack)\n\nUpgrade:\n• 30-40 [Mithril](http://runescape.wikia.com/wiki/Mithril_equipment#Melee_weapons) (Requires 30 Attack)"
     },
     {
  ...
  "40 - 60": {
    ...
    "author": {
     ...
     {
       "name":"Recommended Weapons",
       "value":"• 40-50 [Adamant](http://runescape.wikia.com/wiki/Adamant_equipment#Melee_weapons) (Requires 40 Attack)\n\nUpgrade:\n• 50-60 [Rune](http://runescape.wikia.com/wiki/Rune_equipment#Melee_weapons) (Requires 50 Attack)"
     },
     {
       "name":"Alternative Method",
  ...
  "60 - 70": {
    ...
    "author": {
     ...
     {
       "name":"Recommended Weapons",
       "value":"• 60-70 [Dragon](http://runescape.wikia.com/wiki/Dragon_equipment#Melee_weapons) (Requires 60 Attack)"
     },
     {
       "name":"Alternative Method",
  ...
  "70 - 80": {
    ...
    "author": {
     ...
     {
       "name":"Recommended Weapons",
       "value":"• 70-80 [Guthan's Warspear](http://runescape.wikia.com/wiki/Guthan%27s_warspear) (Requires 70 Attack)"
     },
     {
       "name":"Alternative Method",
     ...
     {
       "name":"Recommended Weapons",
       "value":"• 70-80 [Godsword](http://runescape.wikia.com/wiki/Godsword) (Requires 70 Attack)\nOR\n• 70-80 [Abyssal Whip](http://runescape.wikia.com/wiki/Abyssal_whip) (Requires 70 Attack)"
     }
      ]
  },
  "80 - 99 +": {
    ...
    "author": {
     ...
     {
       "name":"Recommended Weapons",
       "value":"• 80-85 [Crystal Halberd](http://runescape.wikia.com/wiki/Crystal_halberd) (Requires [Roving Elves](http://runescape.wikia.com/wiki/Roving_Elves), 70 Attack and 50 Agility)\nOR\n• 80-85 [Dragon Halberd](http://runescape.wikia.com/wiki/Dragon_halberd) (Requires 60 Attack)\n\nUpgrade:\n• 85-99+ [Dragon Rider Lance](http://runescape.wikia.com/wiki/Dragon_Rider_lance) (Requires 85 Attack)\n\nExpensive Alternative:\n• 90-99+ [Noxious Scythe](http://runescape.wikia.com/wiki/Noxious_scythe) (Requires 90 Attack)"
     },
     {
       "name":"Alternative Method",
  ...
  "abilities": {
    "title": "Abilities",
    "url": "http://runescape.wikia.com/wiki/Abilities#Strength",
  ...
  "alternate methods": {
    ...
    {
      "name": "▬▬ Dark beasts ▬▬",
      "value": "[Dark beast](http://runescape.wikia.com/wiki/Dark_beast) can be an alternative training method at level 90 Strength. They require 90 Slayer to kill, and can be found in the [Mourner Tunnels](http://runescape.wikia.com/wiki/Mourner_Tunnels) (requires [Mournings End End II](http://runescape.wikia.com/wiki/Mourning%27s_End_Part_II)). A player can expect to gain 300,000-600,000 combat experience per hour here."
    },
    {
      "name": "▬▬ Airuts ▬▬",
      "value": "[Airuts](http://runescape.wikia.com/wiki/Airut) can be another level 90 Strength alternative. They require 92 Slayer to kill, and can be found just west of the [Phoenix Lair](http://runescape.wikia.com/wiki/Phoenix_Lair). Aside from the experience per hour gained here, airuts are also great for their drops."
    }
      ]
  },
    ...
    "fields": [
      {
        ...
        "value": "The full list may be found [here](https://runescape.wikia.com/wiki/Quests/Experience_rewards#Strength)."
      }
      ]
  },
...
"value": "[Rush of Blood](https://runescape.wikia.com/wiki/Rush_of_Blood) is a weekly Slayer-themed combat D&D that can be played in [Prifddinas](https://runescape.wikia.com/wiki/Prifddinas), requiring at least level 85 Slayer and completion of [Plague's End](https://runescape.wikia.com/wiki/Plague%27s_End) to take part. It is run by [Morvran Iorwerth](https://runescape.wikia.com/wiki/Morvran), slayer master and former warband leader. Rush of Blood takes place in [Morvran's Dungeon](https://runescape.wikia.com/wiki/Morvran%27s_Dungeon), where waves of different slayer-themed monsters, assembled from Morvran's assignment list, must be fought. Players have ten minutes to dispatch as many foes as possible. The activity can be played once a week for rewards, and any number of times for practice. "
  ...
  "temporary boosts pt2": {
    ...
    "thumbnail": {
      "url": "https://vignette.wikia.nocookie.net/runescape2/images/5/5a/Beer_detail.png/revision/latest?cb=20130109110555"
    },
    "author": {
      "name": "Max Cape Info",
      "icon_url": "https://i.imgur.com/6c6q2iC.png"
