exports.data = {
  ...
  "75 - 99 +": {
    ...
    "author": {
     ...
     "fields": [
     {
       ...
       "value":"At level 75, players should continue to grow [Palm Trees](https://runescape.wiki/w/Palm_tree) until level 99 using [Palm Tree Seeds](https://runescape.wiki/w/Palm_tree_seed). Palm Trees take 960 minutes (6x160 minutes) to grow. If a player chooses to protect them, they must pay the farmer 15 [Papayas](https://runescape.wiki/w/Papaya_fruit) per tree."
     },
     {
       "name":"Calquat Trees Levels 75-99+",
       "value":"At level 75, players should continue to grow [Calquat Trees](https://runescape.wiki/w/Calquat_tree) until level 99 using [Calquat Tree Seeds](https://runescape.wiki/w/Calquat_tree_seed). The patch for planting calquats is located in [Tai Bwo Wannai](https://runescape.wiki/w/Tai_Bwo_Wannai). Calquat Trees take 1,280 minutes (8x160 minutes) to grow. If a player chooses to protect them, they must pay the farmer 8 [Poison Ivy Berries](https://runescape.wiki/w/Poison_ivy_berries) per tree."
     },
     {
  ...
  "offsetting costs": {
    ...
    "description": "There are several ways a player can help relieve the costs from tree seeds. These crops are usually ready faster than most trees, and can be done multiple times a day. For a full list of profitable methods, [click here](https://runescape.wiki/w/Farming_training#Money_making_using_the_Farming_skill).",
  ...
  "alternative methods": {
    ...
    "url": "https://runescape.wiki/w/Farming_training#Alternative_methods_of_gaining_experience",
  ...
  "pet - brains": {
    ...
    "description": "The Brains pet is an item that can be found while training Farming. It can be used to unlock the [Brains pet](https://runescape.wiki/w/Brains).",
  ...
  "quests": {
    ...
    "url": "https://runescape.wiki/w/Quests/Experience_rewards#Farming",
