exports.data = {
  ...
  "1 - 58": {
    "title": "Dungeoneering Level 1-58",
      ...
      {
        "name": "Completion",
        "value": "On completion you will receive an experience penalty and bonus, the penalty for the low complexity and the bonus for your first run. The complexity will then be increased for the next dungeon. The bonus experience will be modified so that you'll get Dungeoneering level 2. Repeat these floors on the highest complexity you can."
      },
      {
        "name": "Prestiging",
  ...
  "58 - 70": {
    ...
    "description": "At this stage you will want to be rushing all of your Frozen and Abandoned 1 floors on complexity level 1. For the Furnished floors to optimise your experience you will want to do floors 18-24 small and then 25-29 large in a team. You will want to do your available Abandoned 2 floors in a team as well set to large. Prestige once youve completed all floors you can and repeat this process until you have reached level 70 Dungeoneering. \n\n • The official world to train dungeoneering is world 77. As dungeoneering can be trained in every world, players who want to train solo or have already found other players to train with are recommended to choose a world in which they have the best connection. \n\n For AHelp members interested in finding partners or groups for dungeoneering training you can get the role `Notify Dungeoneering Team` in the channel `<# 465998663710146579>`.",
    "color": 12269891,
    "footer": {
      "icon_url": "https://cdn.discordapp.com/attachments/297388220231057419/400471386101121024/image.jpg",
      "text": "Achievement Help | Helping you reach your goals, whatever they may be!"
  ...
  "70 - 94": {
    ...
    "description": "From here you want to be rushing through all of the lower floors (1-29) in Complexity one and doing the remaining Abandoned 2 and Occult floors in larges with a group. Prestiging as before making sure you have completed all floors unlocked at your current dungeoneering level.",
    "url": "https://runescape.wikia.com/wiki/Pay-to-play_Dungeoneering_training#Optimising_floors",
    "color": 12269891,
    "footer": {
      "icon_url": "https://cdn.discordapp.com/attachments/297388220231057419/400471386101121024/image.jpg",
  ...
  "94 - 120": {
    ...
    "url": "https://runescape.wikia.com/wiki/Pay-to-play_Dungeoneering_training#Optimising_floors",
    "description": "From level 95 to 120 and beyond you will want to rush all floors including Abandoned 2 (floor 1-35) and only complete Occult and Warped floors in large Complexity 6 with a team. (floors 36-60) You will prestige your progress each time you complete all floors and repeat until you have achieved your level/experience goal. ",
    "url": "https://runescape.wikia.com/wiki/Pay-to-play_Dungeoneering_training#Optimising_floors",
    "color": 12269891,
    "footer": {
      "icon_url": "https://cdn.discordapp.com/attachments/297388220231057419/400471386101121024/image.jpg",
  ...
  "suggestions": {
    ...
    "thumbnail": {
      "url": "https://vignette.wikia.nocookie.net/runescape2/images/1/15/Dungeoneering.png/revision/latest?cb=20120223124111"
    },
    "author": {
      "name": "Max Cape Info",
      "icon_url": "https://i.imgur.com/6c6q2iC.png"
  ...
  "alternate methods": {
    ...
    "fields": [
      {
        "name": "​Sinkholes",
        "value": "The Sinkholes Distraction and Diversion is a short, five-player raid that can be completed twice daily. It allows players to receive Dungeoneering experience from reward lamps, in addition to tokens. "
      },
       {
      ...
      {
        "name": "Elite Dungeons​",
        "value": "Elite dungeons are a set of dungeons that function similar to Raids. Rewards from these dungeons include Dungeoneering experience and tokens as well as a chance to receive loot that include weapons and armour upgrades that range from tier 82 to 92. There are two modes, story and normal mode, and players can choose to solo or join groups of up to three. Story mode reduces the damage enemies deal by 66%, as well as their lifepoints by 50%, but yields no rewards, except lore books, and only 10% of Dungeoneering tokens per miniboss/boss.  "
      }
      ]
  },
  "pet - gordie": {
    ...
    "color": 12269891,
    "footer": {
      "icon_url": "https://vignette.wikia.nocookie.net/runescape2/images/b/ba/Gordie_pet_detail.png/revision/latest?cb=20160823180842",
      "text": "Achievement Help | Helping you reach your goals, whatever they may be!"
    },
    "thumbnail": {
      "url": "https://vignette.wikia.nocookie.net/runescape2/images/b/ba/Gordie_pet_detail.png/revision/latest?cb=20160823180842"
    },
    "author": {
      "name": "Max Cape Info",
      "icon_url": "https://i.imgur.com/6c6q2iC.png"
    ...
    "fields": [
      {
        ...
        "value": "It is unlocked by completing a dungeon floor. Gaining this pet is based on the amount of experience awarded at once; the more experience granted per floor, the greater the chance of gaining this pet. The chance is not affected by experience boosters. All enemies from the lowest tier up to the main bosses in Elite Dungeons also give a small chance to receive the Gordie pet. "
      },
      {
        "name": "Best Method",
        "value": "• The highest chance of unlocking Gordie is through doing solo medium floors at 200M Dungeoneering XP. "
      },
      {
        "name": "Methods which do not Work",
        "value": "• Unlocking resource dungeons does not give a chance of unlocking Gordie, nor does the exp given from the lamp reward from Sinkholes."
      },
      {
        "name": "Formula",
  ...
  "daily challenge": {
    ...
    "description": "Completing a daily challenge in Dungeoneering will give Dungeoneering experience. The amount depends only on a player's level (right after the daily reset), whether they are a member, and whether the task is extended. Based on data, the extended experience is always twice the normal experience (for members), and the non-member experience ratio depends on level.",
