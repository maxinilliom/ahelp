...
"fields": [
      ...
      {
        "name": "General Tips",
        "value": "`Party with people like you`: It is always a good idea to group up with people near your combat level and with similar skill levels. \n\n`Maximise your mods`:  Set the complexity and difficulty to the highest possible, kill as much as you can and open all doors you have access to. \n\n`Turn off guide mode`: Always set guide mode to off as this gives a negative bonus of -2 to -12% (possibly more) which can seriously affect your experience and token gain per hour. \n\n`Survival`: Try to avoid needless deaths. Dying can have big experience penalties ranging between 4% and 70% (you can die up to 15 times, any deaths after 15 don't count) so it is ideal to avoid dying whenever you can."
      }
    ]
  },
  "alternative methods": {
