exports.data = {
  ...
  "58 - 70": {
    ...
    "description": "At this stage you will want to be rushing all of your [Frozen](https://runescape.wiki/w/Dungeoneering_floors#Frozen_floors) and [Abandoned](https://runescape.wiki/w/Dungeoneering_floors#Abandoned_floors) floors on complexity level 1. For the [Furnished](https://runescape.wiki/w/Dungeoneering_floors#Furnished_floors) floors to optimize your experience you will want to do floors 18-24 small and then 25-29 large in a team. You will want to do your available [Abandoned 2](https://runescape.wiki/w/Dungeoneering_floors#Abandoned_2_floors) floors in a team as well set to large. Prestige once you've completed all floors you have available. Repeat this process until you have reached level 70 in Dungeoneering.\n\nNote: The official world to train dungeoneering is world 77. As Dungeoneering can be trained in every world, players who want to train solo or already have partners to train with should choose a world in which they have the best connection.\n\nFor Achievement Help members interested in finding partners or groups for Dungeoneering training, you can self-assign the role `Dungeoneering Team` in the channel <#465998663710146579>.",
            "url": "https://runescape.wiki/w/Pay-to-play_Dungeoneering_training#Optimising_floors",
        "color": 12269891,
            "footer": {
      "icon_url": "https://cdn.discordapp.com/attachments/297388220231057419/400471386101121024/image.jpg",
...
"fields": [
      ...
      {
        "name": "General Tips",
        "value": " • It is always a good idea to group up with people near your combat level and with similar skill levels.\n\n•  Set the complexity and difficulty to the highest possible, kill as much as you can and open all doors you have access to.\n\n• Always set guide mode to off as this gives a negative bonus of -2 to -12% (possibly more) which can seriously affect your experience and token gain per hour.\n\n• Try to avoid needless deaths. Dying can have big experience penalties ranging between 4% and 70% (you can die up to 15 times, any deaths after 15 don't count) so it is ideal to avoid dying whenever you can."
      }
    ]
  },
  "alternative methods": {
  ...
  "pet - gordie": {
    ...
    "fields": [
      ...
      {
        "name": "Best Method",
        "value": "• Solo medium floors, on complexity 6"
      },
      {
        "name": "Methods which do not Work",
        "value": "• Unlocking resource dungeons\n• Sinkholes"
      },
      {
        "name": "Formula",
    ...
    "fields": [
      {
        ...
        "value": "This aura is unlocked by completing the [Daemonheim Tasks](https://runescape.wiki/w/Daemonheim_achievements). There are four tiers of this aura that are rewarded chronologically for completing the easy, medium, hard, and elite task sets. The aura lasts for one hour upon being activated and has a four hour cool-down timer before it can be used again. It can be retrieved from [Thok](https://runescape.wiki/w/Thok_of_Daemonheim) for free if lost. You can activate and wear the aura outside Daemonheim. Whenever the player enters a floor in Daemonheim, the aura will automatically be equipped. The tier 4 aura's effects can be seen [here.](https://runescape.wiki/w/Daemonheim_aura_4) "
      },
      {
