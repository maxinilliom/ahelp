exports.data = {
	...
	"arc - unlocking waiko": {
		...
		"embed": {
			...
			"description": "[Arc - Unlocking Waiko](http://runescape.wikia.com/wiki/Arc_-_Unlocking_Waiko) is an achievement that requires the player to purchase the unlocks from the [Waiko Reward Shop](http://runescape.wikia.com/wiki/Waiko_Reward_Shop) from the list below for a total cost of 7,750 [Chimes](http://runescape.wikia.com/wiki/Chimes) and 5 [Taijitu](http://runescape.wikia.com/wiki/Taijitu).\n\n• Waiko Grill\n• Whale's Maw Camp Fire\n• Whale's Maw Deposit Box\n• Arc Journal Teletabs\n• [Crystal Tool Siphon](https://runescape.wikia.com/wiki/Crystal_tool_siphon) Blueprints",
			"thumbnail": {
				"url": "https://i.imgur.com/gGdB7UR.png"
			},
			"fields": [
	...
	"behemoth notes": {
		...
		"embed": {
			...
			"description": "[Behemoth Notes](http://runescape.wikia.com/wiki/Behemoth_Notes_(achievement%29) is a meta-achievement that requires the player to collect all five [Behemoth notes](http://runescape.wikia.com/wiki/Behemoth_notes) within [Daemonheim](http://runescape.wikia.com/wiki/Daemonheim).\n\nThe Behemoth Notes are a series of journals that players can find while Dungeoneering in Daemonheim. Players can view these by talking to the [Dungeoneering tutor](http://runescape.wikia.com/wiki/Dungeoneering_tutor).",
			"thumbnail": {
				"url": "https://i.imgur.com/Shmagnp.png"
			},
			"fields": [
	...
	"bridge over fremmy waters": {
		...
		"embed": {
			...
			"description": "[Bridge over Fremmy Waters](http://runescape.wikia.com/wiki/Bridge_over_Fremmy_Waters) is an achievement that requires the player to finish all five unabridged [Fremennik Sagas](http://runescape.wikia.com/wiki/Fremennik_Sagas).\n\nThe Fremennik Sagas are a combination of [Questing](http://runescape.wikia.com/wiki/Quests) and [Dungeoneering](http://runescape.wikia.com/wiki/Dungeoneering), where sagas told by [Skaldrun](http://runescape.wikia.com/wiki/Skaldrun) play the main role. All sagas except [Three's Company](http://runescape.wikia.com/wiki/Three%27s_Company) are [Members](http://runescape.wikia.com/wiki/Members)-only.\n\nTo take part in the sagas, Skaldrun must first be unfrozen. He appears randomly on the [Frozen floors](http://runescape.wikia.com/wiki/Dungeoneering_floors#Frozen_floors) (floors 1-11) during a game of Dungeoneering (complexity 2 or higher only). He must be unfrozen with a [Tinderbox](http://runescape.wikia.com/wiki/Tinderbox) and [Logs](http://runescape.wikia.com/wiki/Dungeoneering/Woodcutting), or a [Fire-based spell](http://runescape.wikia.com/wiki/Fire_spell). After he has been found and freed, he can be found on the surface of [Daemonheim](http://runescape.wikia.com/wiki/Daemonheim) near [Thok](http://runescape.wikia.com/wiki/Thok).\n\nTo be able to play any one of the five sagas, players must then find an item while Dungeoneering that jolts Skaldrun's memory about that specific saga. These items cannot be found until after Skaldrun has been found and freed. Each of the five items has a specific range of floors that they can spawn on. All five items can be found on floors of any complexity.",
			"thumbnail": {
				"url": "https://i.imgur.com/Shmagnp.png"
			},
			"fields": [
	...
	"brothers gower": {
		...
		"embed": {
			...
			"description": "[Brothers Gower](http://runescape.wikia.com/wiki/Brothers_Gower) is an achievement that requires the player to claim all three lamps from the Gower brothers after completion of [Gower Quest](http://runescape.wikia.com/wiki/Gower_Quest). They can be found at the [Life altar](http://runescape.wikia.com/wiki/Life_altar).\n\nThe Life altar is a [Runecrafting altar](http://runescape.wikia.com/wiki/Runecrafting_altar) located through a portal in the [Behind the Scenes pub](http://runescape.wikia.com/wiki/Behind_the_Scenes_(location%29).\n\nBehind the Scenes is a location visited during the Gower Quest which resembles a bar. It can be accessed by using a [Disk of returning](http://runescape.wikia.com/wiki/Disk_of_returning_(Gower_Quest%29) in the [Dwarven mines](http://runescape.wikia.com/wiki/Dwarven_Mine) north of [Falador](http://runescape.wikia.com/wiki/Falador), beneath [Ice Mountain](http://runescape.wikia.com/wiki/Ice_Mountain), to [The Black Hole](http://runescape.wikia.com/wiki/The_Black_Hole_(Gower_Quest%29). After the quest, the disk of returning can be used from any bank area.",
			"thumbnail": {
				"url": "https://i.imgur.com/Shmagnp.png"
			},
			"fields": [
	...
	"brutal stuffies": {
		...
		"embed": {
			...
			"description": "[Brutal Stuffies](http://runescape.wikia.com/wiki/Brutal_Stuffies) is an achievement that requires the player to open [Uglug's Stuffsies](http://runescape.wikia.com/wiki/Uglug%27s_Stuffsies) by giving [Uglug Nar](http://runescape.wikia.com/wiki/Uglug_Nar) a [Relicym's balm](http://runescape.wikia.com/wiki/Relicym%27s_balm).\n\nUglug Nar is an ogre shaman who wanders around outside [Jiggig](http://runescape.wikia.com/wiki/Jiggig).\n\nJiggig is a former [Ogre](http://runescape.wikia.com/wiki/Ogre_(race%29) ritual site, located south of [Castle Wars](http://runescape.wikia.com/wiki/Castle_Wars).\n\nRelicym's balm is made by mixing a [Rogue's purse potion (unf)](http://runescape.wikia.com/wiki/Rogue%27s_purse_potion_(unf%29) and a [Clean snake weed](http://runescape.wikia.com/wiki/Clean_snake_weed). It requires level 8 [Herblore](http://runescape.wikia.com/wiki/Herblore) and completion of the [Zogre Flesh Eaters](http://runescape.wikia.com/wiki/Zogre_Flesh_Eaters) quest to the point where [Sithik Ints](http://runescape.wikia.com/wiki/Sithik_Ints) tells the player how to cure the zogre disease.",
			"thumbnail": {
				"url": "https://i.imgur.com/Shmagnp.png"
			},
			"fields": [
	...
	"cecilia, i'm begging you, please...": {
		...
		"embed": {
			...
			"description": "[Cecilia, I'm Begging You, Please...](http://runescape.wikia.com/wiki/Cecilia,_I%27m_Begging_You,_Please...) is an achievement that requires the player to tell [Sister Cecilia](http://runescape.wikia.com/wiki/Sister_Cecilia) whether to leave or stay after the [One Piercing Note](http://runescape.wikia.com/wiki/One_Piercing_Note) quest.\n\nSister Cecilia is a nun of the [Abbey of St. Elspeth Citharede](http://runescape.wikia.com/wiki/Abbey_of_St._Elspeth_Citharede), acting as the choirmistress.\n\nThe Abbey of St. Elspeth Citharede is a large abbey in the desert where the followers of [Saint Elspeth](http://runescape.wikia.com/wiki/Saint_Elspeth) live. It is located east of [Al Kharid](http://runescape.wikia.com/wiki/Al_Kharid), past the [Desert strykewyrms](http://runescape.wikia.com/wiki/Desert_strykewyrm). It is the location where St. Elspeth's remains were found.",
			"thumbnail": {
				"url": "https://i.imgur.com/Shmagnp.png"
			},
			"fields": [
	...
	"chilling with arrav": {
		...
		"embed": {
			...
			"description": "[Chilling with Arrav](http://runescape.wikia.com/wiki/Chilling_with_Arrav) is an achievement that requires the player to put [Arrav](http://runescape.wikia.com/wiki/Arrav) to rest after the [Ritual of the Mahjarrat](http://runescape.wikia.com/wiki/Ritual_of_the_Mahjarrat) quest. He can be located at the burial site, directly north of the tunnel, slightly north east of the [Ritual marker](http://runescape.wikia.com/wiki/Ritual_marker).\n\nThe Ritual marker is an ancient stone located at the [Mahjarrat Ritual Site](http://runescape.wikia.com/wiki/Mahjarrat_Ritual_Site) (also known as The North).\n\nThe Mahjarrat Ritual Site is an icy region located between the [Trollweiss Mountains](http://runescape.wikia.com/wiki/Trollweiss_Mountain) and [Wilderness](http://runescape.wikia.com/wiki/Trollweiss_Mountain).",
			"thumbnail": {
				"url": "https://i.imgur.com/Shmagnp.png"
			},
			"fields": [
	...
	"chivalry is dead": {
		...
		"embed": {
			...
			"description": "[Chivalry is Dead](http://runescape.wikia.com/wiki/Chivalry_is_Dead) is an achievement that requires the player to open all of the coffins and the supply crate in the [Tomb of the Fallen](http://runescape.wikia.com/wiki/Tomb_of_the_Fallen), as well as kick the [Gilded cabbage](http://runescape.wikia.com/wiki/Gilded_cabbage) thirty times, after completion of [The Death of Chivalry](http://runescape.wikia.com/wiki/The_Death_of_Chivalry).\n\nThe Tomb of the Fallen is a crypt explored by the player and [Sir Owen](http://runescape.wikia.com/wiki/Sir_Owen) during The Death of Chivalry. It can be accessed through the portal on the roof of the [Black Knights' Fortress](http://runescape.wikia.com/wiki/Black_Knights%27_Fortress), accessed via [Dulcin](http://runescape.wikia.com/wiki/Dulcin)'s office. \n\nThe gilded cabbage is an extra item obtained after The Death of Chivalry quest. After the quest is completed, it can be looted from one of the coffins in the room where you fight [Dawn](http://runescape.wikia.com/wiki/Dawn), the final boss of the quest.",
			"thumbnail": {
				"url": "https://i.imgur.com/Shmagnp.png"
			},
			"fields": [
	...
	"chivalry is fed": {
		...
		"embed": {
			...
			"description": "[Chivalry Is Fed](http://runescape.wikia.com/wiki/Chivalry_Is_Fed) is an achievement that requires the player to restore the cabbage patch at the north side of [Edgeville Monastery](http://runescape.wikia.com/wiki/Edgeville_Monastery) after [The Death of Chivalry](http://runescape.wikia.com/wiki/The_Death_of_Chivalry) quest. In order to do this, 12 [Cabbage seeds](http://runescape.wikia.com/wiki/Cabbage_seeds) need to be in the player's inventory and used on the scorch marks in the patch. This will cause a short cutscene to play where the patch is restored and the achievement is completed.",
			"thumbnail": {
				"url": "https://i.imgur.com/Shmagnp.png"
			},
			"fields": [
	...
	"chivalry is threads": {
		...
		"embed": {
			...
			"description": "[Chivalry Is Threads](http://runescape.wikia.com/wiki/Chivalry_Is_Threads) is an achievement that requires the player to claim the [Templar armour](http://runescape.wikia.com/wiki/Templar_armour) from one of the coffins in the [Tomb of the Fallen](http://runescape.wikia.com/wiki/Tomb_of_the_Fallen) and the [Dulcin armour](http://runescape.wikia.com/wiki/Dulcin_armour) from defeating [Dawn](http://runescape.wikia.com/wiki/Dawn) after [The Death of Chivalry](http://runescape.wikia.com/wiki/The_Death_of_Chivalry).\n\nThe Tomb of the Fallen is a crypt explored by the player and [Sir Owen](http://runescape.wikia.com/wiki/Sir_Owen) during The Death of Chivalry. It can be accessed through the portal on the roof of the [Black Knights' Fortress](http://runescape.wikia.com/wiki/Black_Knights%27_Fortress), accessed via [Dulcin](http://runescape.wikia.com/wiki/Dulcin)'s office.",
			"thumbnail": {
				"url": "https://i.imgur.com/Shmagnp.png"
			},
			"fields": [
	...
	"circus of fire": {
		...
		"embed": {
			...
			"description": "[Circus of Fire](http://runescape.wikia.com/wiki/Circus_of_Fire) is an achievement that requires the player to obtain the [Firemaker's costume](http://runescape.wikia.com/wiki/Firemaker%27s_costume) from playing the [Firemaking](http://runescape.wikia.com/wiki/Firemaking) area in the [Balthazar Beauregard's Big Top Bonanza](http://runescape.wikia.com/wiki/Balthazar_Beauregard%27s_Big_Top_Bonanza) [Distraction and Diversion](http://runescape.wikia.com/wiki/Distraction_and_Diversion) after completion of [The Firemaker's Curse](http://runescape.wikia.com/wiki/The_Firemaker%27s_Curse).\n\nThe Firemaker's costume is a costume obtained from the Balthazar Beauregard's Big Top Bonanza Distraction and Diversion. It is rewarded to players who earn between 501 and 1,000 points in any of the circus performances after receiving all of the [Acrobat costume](http://runescape.wikia.com/wiki/Acrobat_costume) and completing The Firemaker's Curse. Upon completion of the set, it becomes available as a cosmetic override in the [Customisation](http://runescape.wikia.com/wiki/Customisation) interface.",
			"thumbnail": {
				"url": "https://i.imgur.com/Shmagnp.png"
			},
			"fields": [
	...
	"cook's delights": {
		...
		"embed": {
			...
			"description": "[Cook's Delights](http://runescape.wikia.com/wiki/Cook%27s_Delights) is an achievement that requires the player to complete the [Cook's Assistant](http://runescape.wikia.com/wiki/Cook%27s_Assistant) quest, or talk to the [Cook](http://runescape.wikia.com/wiki/Cook_(Lumbridge%29) if the player has completed the quest before the 20 [Sardines](http://runescape.wikia.com/wiki/Sardine) and 500 [Coins](http://runescape.wikia.com/wiki/Coins) were added as a reward.\n\nThe cook is in the [Lumbridge Castle](http://runescape.wikia.com/wiki/Lumbridge_Castle)'s kitchen on the ground floor on the south side of the castle.",
			"thumbnail": {
				"url": "https://i.imgur.com/Shmagnp.png"
			},
			"fields": [
	...
	"count all light fingers": {
		...
		"embed": {
			...
			"fields": [
				...
				{
					"name": "Guides:",
					"value": "• [From Tiny Acorns Miniquest guide | Runescape Wiki](http://runescape.wikia.com/wiki/From_Tiny_Acorns)\n• [Lost Her Marbles Miniquest guide | Runescape Wiki](http://runescape.wikia.com/wiki/Lost_Her_Marbles)\n• [A Guild of Our Own Miniquest guide | Runescape Wiki](http://runescape.wikia.com/wiki/A_Guild_of_Our_Own)"
				}
			],
			"footer": {
				"icon_url": "https://vignette.wikia.nocookie.net/runescape2/images/e/e9/Runescore.png",
	...
	"daero take this experience?": {
		...
		"embed": {
			...
			"description": "[Daero Take This Experience?](http://runescape.wikia.com/wiki/Daero_Take_This_Experience) is an achievement that requires the player to claim the total of 110,000 combat experience from [Daero](http://runescape.wikia.com/wiki/Daero) after completion of [Monkey Madness](http://runescape.wikia.com/wiki/Monkey_Madness).\n\nDaero is the new tree guardian of the [Tree Gnome Stronghold](http://runescape.wikia.com/wiki/Tree_Gnome_Stronghold), who is found at [Blurberry's Bar](http://runescape.wikia.com/wiki/Blurberry%27s_Bar) on the first floor of the [Grand Tree](http://runescape.wikia.com/wiki/Grand_Tree).",
			"thumbnail": {
				"url": "https://i.imgur.com/Shmagnp.png"
			},
			"fields": [
	...
	"elven titles": {
		...
		"embed": {
			...
			"description": "[Elven Titles](http://runescape.wikia.com/wiki/Elven_Titles) is an achievement that requires the player to obtain the clan-named elven titles after [Plague's End](http://runescape.wikia.com/wiki/Plague%27s_End) in [Prifddinas](http://runescape.wikia.com/wiki/Prifddinas).\n\nThe methods of obtaining the titles are:\n\n• **of the Trahaearn:** Obtain 100 [Corrupted ores](http://runescape.wikia.com/wiki/Corrupted_ore) while mining [Seren stones](http://runescape.wikia.com/wiki/Seren_stone).\n• **of the Iorwerth:** Complete 8 [Dark beast](http://runescape.wikia.com/wiki/Dark_beast) slayer assignments assigned by [Morvran](http://runescape.wikia.com/wiki/Morvran).\n• **of the Cadarn:** Defeat 1,000 [Cadarn rangers](http://runescape.wikia.com/wiki/Cadarn_ranger) or [Magi](http://runescape.wikia.com/wiki/Cadarn_magus) in combat.\n• **of the Crwys:** Check the health of an [Elder tree](http://runescape.wikia.com/wiki/Elder_tree) grown in the elder tree patch in the [Crwys Clan](http://runescape.wikia.com/wiki/Crwys_Clan) district in Prifddinas.\n• **of the Amlodd:** Summon a [Light creature familiar](http://runescape.wikia.com/wiki/Light_creature_(familiar%29), use an [Enlightenment scroll](http://runescape.wikia.com/wiki/Enlightenment_scroll), then talk to [Lord Amlodd](http://runescape.wikia.com/wiki/Lord_Amlodd).\n• **of the Ithell:** Craft 100 [Crystal flasks](http://runescape.wikia.com/wiki/Crystal_flask).\n• **of the Hefin:** Complete 200 laps of the [Hefin Agility Course](http://runescape.wikia.com/wiki/Hefin_Agility_Course).\n• **of the Meilyr:** Harvest 50 [Harmony moss](http://runescape.wikia.com/wiki/Harmony_moss) from the [Harmony pillars](http://runescape.wikia.com/wiki/Harmony_pillar).",
			"thumbnail": {
				"url": "https://i.imgur.com/Shmagnp.png"
			},
			"fields": [
	...
	"famous": {
		...
		"embed": {
			...
			"description": "[Famous](http://runescape.wikia.com/wiki/Famous_(achievement%29) is an achievement that requires the player to complete [Morvran](https://runescape.wikia.com/wiki/Morvran)'s [special Slayer challenge](https://runescape.wikia.com/wiki/Slayer/Challenges#Morvran) and earning the title: `The Famous`.\n\nBy killing the required bosses, the player will acquire [dark crystals](https://runescape.wikia.com/wiki/Dark_crystal) in their inventory. These crystals will give the player debuffs for killing the remaining bosses. Although the crystals can be banked, the player must carry all collected crystals while killing the remaining bosses or they will not progress through the challenge. These debuffs will affect the player in various ways by reducing their damage dealt and amount healed by the player or increasing the damage they take. Thus, it is wise to do the harder bosses first and finish with the easier ones.",
			"thumbnail": {
				"url": "https://i.imgur.com/Shmagnp.png"
			},
			"fields": [
	...
	"imping around": {
		...
		"embed": {
			...
			"description": "[Imping Around](http://runescape.wikia.com/wiki/Imping_Around) is an achievement that requires the player to catch one of each type of [impling](https://runescape.wikia.com/wiki/Impling) for [Daffyd](https://runescape.wikia.com/wiki/Daffyd) after speaking to him. In [Puro-Puro](https://runescape.wikia.com/wiki/Puro-Puro), a net and empty jars are required to catch any implings. They can be caught with a [butterfly net](https://runescape.wikia.com/wiki/Butterfly_net), [magic butterfly net](https://runescape.wikia.com/wiki/Magic_butterfly_net), [sacred clay butterfly net](https://runescape.wikia.com/wiki/Sacred_clay_butterfly_net), or [volatile clay butterfly net](https://runescape.wikia.com/wiki/Volatile_clay_butterfly_net). Jars can be exchanged and bought from [Elnock Inquisitor](https://runescape.wikia.com/wiki/Elnock_Inquisitor) in Puro-Puro or generated with a [jar generator](https://runescape.wikia.com/wiki/Jar_generator). In [Gielinor](https://runescape.wikia.com/wiki/Gielinor), they can also be caught barehanded and without an empty impling jar. Players can use the spells [Bind](https://runescape.wikia.com/wiki/Bind), [Snare](https://runescape.wikia.com/wiki/Snare), and [Entangle](https://runescape.wikia.com/wiki/Entangle) to keep an impling from moving further away.",
			"thumbnail": {
				"url": "https://i.imgur.com/Shmagnp.png"
			},
			"fields": [
				...
				},
				{
					...
					"value": "• [Baby impling](https://runescape.wikia.com/wiki/Baby_impling)\n• [Young impling](https://runescape.wikia.com/wiki/Young_impling)\n• [Gourmet impling](https://runescape.wikia.com/wiki/Gourmet_impling)\n• [Earth impling](https://runescape.wikia.com/wiki/Earth_impling)\n• [Essence impling](https://runescape.wikia.com/wiki/Essence_impling)\n• [Eclectic impling](https://runescape.wikia.com/wiki/Eclectic_impling)\n• [Spirit impling](https://runescape.wikia.com/wiki/Spirit_impling)\n• [Nature impling](https://runescape.wikia.com/wiki/Nature_impling)"
				},
				{
					"name": "​",
					"value": "• [Magpie impling](https://runescape.wikia.com/wiki/Magpie_impling)\n• [Ninja impling](https://runescape.wikia.com/wiki/Ninja_impling)\n• [Pirate impling](https://runescape.wikia.com/wiki/Pirate_impling)\n• [Divine impling](https://runescape.wikia.com/wiki/Divine_impling)\n• [Dragon impling](https://runescape.wikia.com/wiki/Dragon_impling)\n• [Zombie impling](https://runescape.wikia.com/wiki/Zombie_impling)\n• [Kingly impling](https://runescape.wikia.com/wiki/Kingly_impling)\n• [Crystal impling](https://runescape.wikia.com/wiki/Crystal_impling)\n\nPlayers may sign up for the <@&476802397851746316> role in the <#465998663710146579> channel to be notified when a Crystal impling is spotted."
				},
				{
					"name": "Requirements:",
					"value": "• 95 Hunter\n\n• Plague's End Quest completion | [Runescape Wiki](http://runescape.wikia.com/wiki/Plague%27s_End)"
	...
	"invention gives me the blues": {
		...
		"embed": {
			...
			"description": "[Invention Gives Me the Blues](http://runescape.wikia.com/wiki/Invention_Gives_Me_the_Blues) is an achievement that requires the player to buy all the blueprints in the [dwarven](https://runescape.wikia.com/wiki/Dwarven_technology_tree) and [cave goblin technology trees](https://runescape.wikia.com/wiki/Cave_goblin_technology_tree).",
			"thumbnail": {
				"url": "https://i.imgur.com/Shmagnp.png"
			},
			"fields": [
				...
				},
				{
					...
					"value": "• [Corporeal components](https://runescape.wikia.com/wiki/Corporeal_components)\n• [Sprinkler MK1](https://runescape.wikia.com/wiki/Sprinkler_MK1)\n• [Mining accumulator](https://runescape.wikia.com/wiki/Mining_accumulator)\n• [Book switcher](https://runescape.wikia.com/wiki/Book_switcher)\n• [Calorie bomb (empty)](https://runescape.wikia.com/wiki/Calorie_bomb_(empty)\n• [Auto-sanctifier](https://runescape.wikia.com/wiki/Auto-sanctifier)\n• [Kinetic cyclone](https://runescape.wikia.com/wiki/Kinetic_cyclone)\n• [Dungeoneering lock melter](https://runescape.wikia.com/wiki/Dungeoneering_lock_melter)"
				},
				{
					"name": "Cave Goblin Technology Tree:",
					"value": "The cave goblin tech tree is a tree of technology from Invention. At level 40, you may choose to follow this path by talking to Oldak in Dorgesh-Kaan.\n\nCave goblin technology tree items can be unlocked using Cave goblin currency which is earned by completing Invention tasks. A total of 295 Cave goblin currency is required to complete this portion of the achievement. These tasks can also be found at the noticeboard in the Invention guild, in [Dorgesh-Kaan](https://runescape.wikia.com/wiki/Dorgesh-Kaan) near [Oldak](https://runescape.wikia.com/wiki/Oldak), and near Drorkar in Keldagrim. Up to 5 tasks can be saved and each 12 hours a new task is added."
				},
				{
	...
	"jack of the circus": {
		...
		"embed": {
            ...
            "description": "[Jack of the Circus](https://runescape.wikia.com/wiki/Jack_of_the_Circus) is an achievement that requires the player to claim all of the circus equipment from [Balthazar Beauregard's Big Top Bonanza](https://runescape.wikia.com/wiki/Balthazar_Beauregard%27s_Big_Top_Bonanza). These costumes can be gained through getting points in activities. Repeating any trick will not result in more experience so you need to work through different tricks. This is different from the way Circus score is earned, where players can repeatedly perform the same high-level trick to increase their score (as long as they take measures to ensure they do not become boring). Therefore players wishing to maximise their experience gain do so at the expense of their Circus score. To get the lower level costumes, you will need to get their score range needed as going above will roll you a no reward if you have all rewards of the higher tier. With this being the case, it would be beneficial to attempt for the Ringmaster outfit first so failed attempts are still rewarding.\n\n Players will need to have purchased the full following costumes:\n• [Audience](https://runescape.wikia.com/wiki/Audience_costume)\n• [Acrobat](https://runescape.wikia.com/wiki/Acrobat_costume)\n• [Firemakers](https://runescape.wikia.com/wiki/Firemaker%27s_costume)\n• [Clown](https://runescape.wikia.com/wiki/Clown_costume)\n• [Ringmaster](https://runescape.wikia.com/wiki/Ringmaster_costume)",
            "thumbnail": {
                "url": "https://i.imgur.com/Shmagnp.png"
            },
            "fields": [
	...
	"kal'gerion commander": {
		...
		"embed": {
            ...
            "description": "[Kal'gerion Commander](https://runescape.wikia.com/wiki/Kal%27gerion_Commander) is an achievement that requires the player to find all of the [Kal'gerion battle commendations](https://runescape.wikia.com/wiki/Kal%27gerion_battle_commendation) which are dropped by [Kal'gerion demons](https://runescape.wikia.com/wiki/Kal%27gerion_demon). Currently, it is advised players kill Kal'gerion demons in a [Player owned slayer dungeon](https://runescape.wikia.com/wiki/Sunken_Pyramid#Slayer_Dungeon) as they will be unable to utilize their special attack in this area. Players may visit the `Slayer Dungs` FC to find an availble POD.\n\n There are 5 titles to collect:\n• [the Bloodchiller](https://runescape.wikia.com/wiki/The_Bloodchiller)\n• [the Riftsplitter](https://runescape.wikia.com/wiki/The_Riftsplitter)\n• [the Pummeller](https://runescape.wikia.com/wiki/The_Pummeller)\n• [the Thunderous](https://runescape.wikia.com/wiki/The_Thunderous)\n• [the Warmonger](https://runescape.wikia.com/wiki/The_Warmonger)",
            "thumbnail": {
                "url": "https://i.imgur.com/Shmagnp.png"
            },
            "fields": [
	...
	"long live the queen": {
		...
		"embed": {
			...
			"description": "[Long Live the Queen](http://runescape.wikia.com/wiki/Long_Live_the_Queen) is an achievement that requires the player to obtain the [first dragonkin journal](https://runescape.wikia.com/wiki/First_dragonkin_journal) as drop from the first kill of the [Queen Black Dragon](https://runescape.wikia.com/wiki/Queen_Black_Dragon).\n\nThe first dragonkin journal is a 100% drop from a player's first kill of the Queen Black Dragon. It describes how the Queen Black Dragon was created and tells of the curse of the dragonkin: to feel pain whenever the Stone of Jas is used by a False User.",
			"thumbnail": {
				"url": "https://i.imgur.com/Shmagnp.png"
			},
			"fields": [
	...
	"make them bleed": {
		...
		"embed": {
			...
			"description": "[Make Them Bleed](http://runescape.wikia.com/wiki/Make_Them_Bleed) is an achievement that requires the player to clear wave twenty of any difficulty of [Rush of Blood](https://runescape.wikia.com/wiki/Rush_of_Blood) to claim the [Slayer XP lamp](https://runescape.wikia.com/wiki/Slayer_XP_lamp) from [Morvran](https://runescape.wikia.com/wiki/Morvran). Twenty waves need to be cleared, reaching wave 20 does not suffice. Players are not required to be on a reward run to complete this achievement, it can be done during a regular run.\n\nRush of Blood is a weekly Slayer-themed combat [Distraction and Diversion](https://runescape.wikia.com/wiki/Distractions_and_Diversions) that can be played in [Prifddinas](https://runescape.wikia.com/wiki/Prifddinas). It is run by Morvran Iorwerth, slayer master and former warband leader, and takes place in [his dungeon](https://runescape.wikia.com/wiki/Morvran%27s_Dungeon) underneath the [Iorwerth Clan](https://runescape.wikia.com/wiki/Iorwerth_Clan) district. In the D&D, waves of different monsters, drawn from Morvran's assignment list, must be fought and one is given ten minutes to do so.\n\nThe timer does not begin until the player passes the barrier. A bank chest is available just outside of the arena, and can be accessed at any time. Doing so will not pause the timer. This means that use of the chest should be judged wisely.\n\n Players may utilize the [Rush of blood damage enhancer](https://runescape.wikia.com/wiki/Rush_of_blood_damage_enhancer), which gives a 10% damage boost.",
			"thumbnail": {
				"url": "https://i.imgur.com/Shmagnp.png"
			},
			"fields": [
	...
	"master angler": {
		...
		"embed": {
            ...
            "description": "[Master Angler](http://runescape.wikia.com/wiki/Master_Angler) is an achievement that requires the player to obtain the [Champion's tackle box](https://runescape.wikia.com/wiki/Champion%27s_tackle_box) from [Fish Flingers](https://runescape.wikia.com/wiki/Fish_Flingers). This requires a total of 1860 [Tokens](https://runescape.wikia.com/wiki/Fish_Flingers#Tokens) and 500 [Medals](https://runescape.wikia.com/wiki/Fish_Flingers#Medals). You should utilize `FishFlingers` fc to complete this requirement. You want to be in there during reset if you can, otherwise it’s a rather dead place to be. You can stock up to 15 tickets total by talking to the fish master at any fishing location. You can get more tickets from fishing, but it’s slow and isn’t worth doing unless it’s your last requirement. A [Fish Flingers medal enhancer](https://runescape.wikia.com/wiki/Fish_flingers_medal_enhancer) can speed it up a bit, but it only doubles medals, not tokens. However, this allows you to [Quick cast](https://runescape.wikia.com/wiki/Fish_Flingers#Quick_casting) games once you receive all medals and it is a much less stressful playthrough.\n\nMedals are given for the following achievements:\n• Junior Angler: Find the perfect tackle for three species.\n• Master Angler: Find the perfect tackle for all six species.\n• Whopper: Catch 3 big fish.\n• Team Player: Assist in catching at least 6 big fish.\n\nIt is highly recommended to use the [Alt1 application](https://runeapps.org/alt1) to quickly find the perfect tackle combination. Once you reach 500 medals, you’ll want to ignore going for medals and find the heaviest fish spot (this is called in the aforementioned friends chat) and just quick cast that location. Meaning as soon as you get the message that you caught a fish, you cast again. This gives most tokens per games. ",
            "thumbnail": {
                "url": "https://i.imgur.com/Shmagnp.png"
            },
            "fields": [
	...
	"master of assault": {
		...
		"embed": {
            ...
            "description": "[Master of Assault](https://runescape.wikia.com/wiki/Master_of_Assault) is an achievement that requires the player to play [Barbarian Assault](https://runescape.wikia.com/wiki/Barbarian_Assault) until they have achieved the maximum rank (5) in all of the roles: [Attacker](https://runescape.wikia.com/wiki/Barbarian_Assault#Attacker), [Collector](https://runescape.wikia.com/wiki/Barbarian_Assault#Collector), [Defender](https://runescape.wikia.com/wiki/Barbarian_Assault#Defender), and [Healer](https://runescape.wikia.com/wiki/Barbarian_Assault#Healer). Players may wish to utilize the friend chat `ba teams` or the **@Barbarian Assault** tag in this server to help complete this requirement. This should be completed in [Hard mode](https://runescape.wikia.com/wiki/Barbarian_Assault:_Hard_Mode) for maximum points per round.",
            "thumbnail": {
                "url": "https://i.imgur.com/Shmagnp.png"
            },
            "fields": [
	...
	"master quester": {
		...
		"embed": {
			...
			"description": "[Master Quester](http://runescape.wikia.com/wiki/Master_Quester) is an achievement that is awarded after the completion of all available [quests](https://runescape.wikia.com/wiki/Quests). The achievement also tracks the player's [quest points](https://runescape.wikia.com/wiki/Quest_points). The current total is 399 quest points.\n\nQuests are groups of interrelated tasks, usually involving a storyline, that can take anywhere from a few minutes to a few hours or even a few days to complete.\n\nThe starting locations for all quests are labelled with a [blue compass icon](https://vignette.wikia.nocookie.net/runescape2/images/8/8f/Quest_map_icon.png/revision/latest?cb=20160402030214) on the [minimap](https://runescape.wikia.com/wiki/Minimap), and completing them can provide rewards ranging from experience and items, to access to new areas, [minigames](https://runescape.wikia.com/wiki/Minigames) and [miniquests](https://runescape.wikia.com/wiki/Miniquests).",
			"thumbnail": {
				"url": "https://i.imgur.com/Shmagnp.png"
			},
			"fields": [
				...
				{
					"name": "Guides:",
					"value": "[List of Quests and Guides | Runescape Wiki](http://runescape.wikia.com/wiki/List_of_quests)"
				}
			],
			"footer": {
				"icon_url": "https://vignette.wikia.nocookie.net/runescape2/images/e/e9/Runescore.png",
	...
	"master skiller": {
		...
		"embed": {
			...
			"description": "[Master Skiller](http://runescape.wikia.com/wiki/Master_Skiller) is an achievement that tracks the player's progress towards skill levels needed for the [completionist cape](https://runescape.wikia.com/wiki/Completionist_cape).",
			"thumbnail": {
				"url": "https://i.imgur.com/Shmagnp.png"
			},
			"fields": [
	...
	"mazcab telport": {
		...
		"embed": {
            ...
            "description": "[Mazcab Teleport](https://runescape.wikia.com/wiki/Mazcab_Teleport_(achievement) is an achievement that requires the player to unlock the [Mazcab Teleport spell](https://runescape.wikia.com/wiki/Mazcab_Teleport) by reading a [Mazcab teleport codex](https://runescape.wikia.com/wiki/Mazcab_teleport_codex).  It can be bought from the [Armoursmith](https://runescape.wikia.com/wiki/Armoursmith) for 2,000 [Teci](https://runescape.wikia.com/wiki/Teci). Teci is the currency of the [Liberation of Mazcab](https://runescape.wikia.com/wiki/Liberation_of_Mazcab) Raid. It is obtained by defeating [Beastmaster Durzag](https://runescape.wikia.com/wiki/Beastmaster_Durzag) and [Yakamaru](https://runescape.wikia.com/wiki/Yakamaru). You may post in the #436714722847621120 channel if you are in need of a Raids Team for this requirement.",
            "thumbnail": {
                "url": "https://i.imgur.com/Shmagnp.png"
            },
            "fields": [
	...
	"memorialised more than once": {
		...
		"embed": {
            ...
            "fields": [
				...
				{
					"name": "​",
					"value": "• **Engram:** [Elder Sword](https://runescape.wikia.com/wiki/Elder_Sword_engram)\n\t• **Location:** Found at the [Void Knights' Outpost](https://runescape.wikia.com/wiki/Void_Knights%27_Outpost), on the south-east end of the island directly east of the bank on top of a barrel near the beacon under a canopy"
				},
				{
					"name": "​",
					"value": "• **Engram:** [Sword of Edicts](https://runescape.wikia.com/wiki/Sword_of_Edicts_engram)\n\t• **Location:** Found near the [Sword of Edicts](https://runescape.wikia.com/wiki/Sword_of_Edicts) in the center of the [Wilderness Volcano](https://runescape.wikia.com/wiki/Wilderness_Volcano), slightly east of the [cursed energy](https://runescape.wikia.com/wiki/Cursed_energy) divination location"
				},
				{
					"name": "​",
					"value": "• **Engram:** [Guardians of Guthix](https://runescape.wikia.com/wiki/Guardians_of_Guthix_engram)\n\t• **Location:** South of [Juna](https://runescape.wikia.com/wiki/Juna) at the [Tears of Guthix](https://runescape.wikia.com/wiki/Tears_of_Guthix) D&D"
				},
				{
					"name": "​",
					"value": "• **Engram:** [World Gate](https://runescape.wikia.com/wiki/World_Gate_engram)\n\t• **Location:** Found in some rocks just north-east of the [World Gate](https://runescape.wikia.com/wiki/World_Gate), above 2 small pools of water"
				},
				{
					"name": "​",
					"value": "• **Engram:** [Druid](https://runescape.wikia.com/wiki/Druid_engram)\n\t• **Location:** Found in the church building north-east of the [god statue](https://runescape.wikia.com/wiki/God_Statues) in [Burthorpe](https://runescape.wikia.com/wiki/Burthorpe), on top of the altar"
				},
				{
					"name": "​",
					"value": "• **Engram:** [Balance Elemental](https://runescape.wikia.com/wiki/Balance_Elemental_engram)\n\t• **Location:** Found inside the centre standing stone, north of [Falador](https://runescape.wikia.com/wiki/Falador), east of the [lodestone](https://runescape.wikia.com/wiki/Lodestone_Network)"
				},
				{
					"name": "​",
					"value": "• **Engram:** [Sheep](https://runescape.wikia.com/wiki/Sheep_engram)\n\t• **Location:** Found on the table of [Fred the Farmer](https://runescape.wikia.com/wiki/Fred_the_Farmer)'s house in northern [Lumbridge](https://runescape.wikia.com/wiki/Lumbridge)"
				},
				{
					"name": "​",
					"value": "• **Engram:** [Time](https://runescape.wikia.com/wiki/Time_engram)\n\t• **Location:** Found on the south side of [Glarial's tombstone](https://runescape.wikia.com/wiki/Glarial%27s_tombstone), north-west of the [Fishing Guild](https://runescape.wikia.com/wiki/Fishing_Guild), under a bush at the base of a tree"
				},
				{
					"name": "​",
					"value": "• **Engram:** [Fairy](https://runescape.wikia.com/wiki/Fairy_engram)\n\t• **Location:** Found under the mushrooms by the sand pit, east of the wheat field in [Zanaris](https://runescape.wikia.com/wiki/Zanaris)"
				},
				{
					"name": "​",
					"value": "• **Engram:** [Gnome](https://runescape.wikia.com/wiki/Gnome_engram)\n\t• **Location:** Found in the south central dead end of the [Gnome Maze](https://runescape.wikia.com/wiki/Gnome_Maze). If entering from the south eastern entrance, the engram can be seen over the wall and clicking on it should be able to path you there. The path will take you northwest and then back south"
				},
				{
					"name": "​",
	...
	"memories of guthix": {
		...
		"embed": {
			...
			"description": "[Memories of Guthix](http://runescape.wikia.com/wiki/Memories_of_Guthix_(achievement%29) is an achievement that requires the player to complete the [Memorial to Guthix](https://runescape.wikia.com/wiki/Memorial_to_Guthix) at least once by collecting all [engrams](https://runescape.wikia.com/wiki/Engram), charging them, and handing them in to [Orla Fairweather](https://runescape.wikia.com/wiki/Orla_Fairweather)\n\nOrla can be found west of the [Lumbridge crater](https://runescape.wikia.com/wiki/Lumbridge_Crater), in [Burthorpe](https://runescape.wikia.com/wiki/Burthorpe), and at the Memorial to Guthix.\n\n\n\nThe memorial site is located in the [Piscatoris Hunter area](https://runescape.wikia.com/wiki/Piscatoris_Hunter_area), just north of the [ferrets](https://runescape.wikia.com/wiki/Ferret) and [Nickolaus](https://runescape.wikia.com/wiki/Nickolaus)'s camp and just south of the [Phoenix Lair](https://runescape.wikia.com/wiki/Phoenix_Lair) and the [Airut](https://runescape.wikia.com/wiki/Airut). Players can teleport directly to the shrine through the use of [memory strands](https://runescape.wikia.com/wiki/Memory_strand), [Sixth-Age circuit](https://runescape.wikia.com/wiki/Sixth-Age_circuit) and charged engrams.\n\nWhile training Divination outside of Dungeoneering, memory strands can be collected and stored in the currency pouch. The strands are stored automatically after adding the strands to the currency pouch for the first time. These strands can be combined with engrams which can be found all around Gielinor to create echoes. Echoes can be placed in the temple to unlock beneficial buffs, gain Divination experience, and reveal lore about Guthix's life on Gielinor.",
			"thumbnail": {
				"url": "https://i.imgur.com/Shmagnp.png"
			},
			"fields": [
	...
	"music maestro": {
		...
		"embed": {
			...
			"description": "[Music Maestro](http://runescape.wikia.com/wiki/Music_Maestro) is an achievement that tracks the amount of [music tracks](https://runescape.wikia.com/wiki/Music) the player has unlocked. The current total is 1229. You can click on the song in game to view what needs done in order to unlock it.\n\nMusic in RuneScape is mostly in-game background music (music tracks) designed to enhance a player's gaming experience and fit with the environment the avatar is in. Music in RuneScape draws inspiration from progressive rock, with elements of classical and world music. Players need to unlock most tracks during gameplay by going to a particular [place](https://runescape.wikia.com/wiki/Locations), completing a [quest](https://runescape.wikia.com/wiki/Quests), or performing some action.",
			"thumbnail": {
				"url": "https://i.imgur.com/Shmagnp.png"
			},
			"fields": [
	...
	"nomad's mirage": {
		...
		"embed": {
            ...
            "description": "[Nomad's Mirage](http://runescape.wikia.com/wiki/Nomad%27s_Mirage) is an achievement that requires the player to defeat the [Memory of Nomad](https://runescape.wikia.com/wiki/Memory_of_Nomad) and loot the chest thereafter. If you struggle with PvM, it is advised to bring a [Pack Mammoth](https://runescape.wikia.com/wiki/Pack_mammoth) and [Mammoth feast scrolls](https://runescape.wikia.com/wiki/Mammoth_feast_scroll) for eating, as this uses no adreniline and consequently supplies more damage per second. Also, remember to utilize [Devotion](https://runescape.wikia.com/wiki/Devotion), [Barricade](https://runescape.wikia.com/wiki/Barricade), and [Debilitate](https://runescape.wikia.com/wiki/Debilitate) abilities. Protection prayers being kept up on last phase is of dire importance.\n\nThe Memory of Nomad is essentially a hard mode version of the fight in [Nomad's Elegy](https://runescape.wikia.com/wiki/Nomad%27s_Elegy). Most of the mechanics are the same as in the normal fight but there are a few additional mechanics, especially in the final phase. There are also no checkpoints, so all four phases must be completed in one go.",
            "thumbnail": {
                "url": "https://i.imgur.com/Shmagnp.png"
            },
            "fields": [
	...
	"on a rune high": {
		...
		"embed": {
            ...
            "description": "[On a Rune High](https://runescape.wikia.com/wiki/On_a_Rune_High) is an achievement that requires the player to unlock the highest rune shop from [Ali Morrisane](https://runescape.wikia.com/wiki/Ali_Morrisane) by completing the [Rogue Trader miniquest](https://runescape.wikia.com/wiki/Rogue_Trader). There are 3 parts to the Rogue Trader miniquest. Each part allows the player to buy something different from Ali Morrisane. Completing this achievement requires the player to open a large casket of runes. Simply unlocking the ability to open them, or opening a small casket, is insufficient.",
            "thumbnail": {
                "url": "https://i.imgur.com/Shmagnp.png"
            },
            "fields": [
	...
	"out into the ourania": {
		...
		"embed": {
			...
			"description": "[Out into the Ourania](https://runescape.wikia.com/wiki/Out_into_the_Ourania) is an achievement that requires the player to unlock the [Ourania Teleport](https://runescape.wikia.com/wiki/Ourania_Teleport) spell by talking to [Baba Yaga](https://runescape.wikia.com/wiki/Baba_Yaga) with the [Lunar spellbook](https://runescape.wikia.com/wiki/Lunar_spells) active after completion of [Lunar Diplomacy](https://runescape.wikia.com/wiki/Lunar_Diplomacy).\n\nBaba Yaga is a member of the [Moon Clan](https://runescape.wikia.com/wiki/Moon_Clan) on [Lunar Isle](https://runescape.wikia.com/wiki/Lunar_Isle) who lives in [the house that walks about upon chicken legs](https://runescape.wikia.com/wiki/Baby_Yaga%27s_House).\n\nPlayers can travel to Lunar Isle using the [Lodestone Network](https://runescape.wikia.com/wiki/Lodestone_Network) once they have activated the necessary lodestone or use the [Moonclan Teleport](https://runescape.wikia.com/wiki/Moonclan_Teleport).",
			"thumbnail": {
				"url": "https://i.imgur.com/Shmagnp.png"
			},
			"fields": [
	...
	"penance to the king": {
		...
		"embed": {
            ...
            "description": "[Penance to the King](http://runescape.wikia.com/wiki/Penance_to_the_King) is an achievement that requires the player to kill the [Penance King](https://runescape.wikia.com/wiki/Penance_King) after doing all 10 hard-mode waves in [Barbarian Assault](https://runescape.wikia.com/wiki/Barbarian_Assault). Players may wish to utilize the friend chat `BA teams` or the **@Penance King** role call in this discord to help complete this requirement. ",
            "thumbnail": {
                "url": "https://i.imgur.com/Shmagnp.png"
            },
            "fields": [
	...
	"perky like a prawn": {
		...
		"embed": {
            ...
            "description": "[Perky like a Prawn](https://runescape.wikia.com/wiki/Perky_like_a_Prawn) is an achievement that requires the player to unlock all [Prawn perks](https://runescape.wikia.com/wiki/Prawnbroker#Prawn_Perks) from the [Prawnbroker](https://runescape.wikia.com/wiki/Prawnbroker). This can be done by collecting [Golden fish eggs](https://runescape.wikia.com/wiki/Golden_fish_egg) and gaining 1, 20, 100, and 200 [Prawn balls](https://runescape.wikia.com/wiki/Prawn_balls) and [Prawn crackers](https://runescape.wikia.com/wiki/Prawn_cracker). Fifty bonus prawn balls are available to players who have obtained level 99 Fishing by speaking to the Prawnbroker. You may also ask other players if they have extra golden crackers they could pull with you in order for you to quickly complete this requirement. You may tag the **@Golden Crackers** role in this discord to inquire about availability as well. ",
            "thumbnail": {
                "url": "https://i.imgur.com/Shmagnp.png"
            },
            "fields": [
	...
	"potion for a lady": {
		...
		"embed": {
			...
			"description": "[Potion for a Lady](http://runescape.wikia.com/wiki/Potion_for_a_Lady) is an achievement that requires the player to find one [unreadable page](https://runescape.wikia.com/wiki/Unreadable_page) in [Daemonheim](https://runescape.wikia.com/wiki/Daemonheim) and giving [Lady Meilyr](https://runescape.wikia.com/wiki/Lady_Meilyr) a self made [super melee potion](https://runescape.wikia.com/wiki/Super_melee_potion) in exchange for the [melee XP lamp](https://runescape.wikia.com/wiki/Melee_XP_lamp).\n\nAn unreadable page is a lost text containing recipes for the [Meilyr Clan](https://runescape.wikia.com/wiki/Meilyr_Clan) in [Prifddinas](https://runescape.wikia.com/wiki/Prifddinas). It can be found within Daemonheim on any floor at any complexity (even on free worlds), or received from the [Motherlode Maw](https://runescape.wikia.com/wiki/Motherlode_Maw). [Hard mode](https://runescape.wikia.com/wiki/Dungeoneering/Hard_mode) floors will increase the chances of a page appearing however, there is no guarantee that a page will be found on any floor. A [perfect juju herblore potion](https://runescape.wikia.com/wiki/Perfect_juju_herblore_potion) will increase the chance of finding a page by 10%, and a [perfect juju dungeoneering potion](https://runescape.wikia.com/wiki/Dungeoneering/Hard_mode) can also increase the chance. A page is a guaranteed find with a [Consistent yak solo](https://runescape.wikia.com/wiki/Consistent_yak_card_(solo) / [team card](https://runescape.wikia.com/wiki/Consistent_yak_card_(team) obtained from [Gorajo hoardstalker](https://runescape.wikia.com/wiki/Gorajo_hoardstalker).",
			"thumbnail": {
				"url": "https://i.imgur.com/Shmagnp.png"
			},
			"fields": [
	...
	"potion mixer master": {
		...
		"embed": {
			...
			"description": "[Potion Mixer Master](http://runescape.wikia.com/wiki/Potion_Mixer_Master) is an achievement that requires the player to collect all 26 [combination potions](https://runescape.wikia.com/wiki/Combination_potions) by either buying the recipe in the [Recipe Shop](https://runescape.wikia.com/wiki/Recipe_Shop) or finding [unreadable pages](https://runescape.wikia.com/wiki/Unreadable_page) in [Daemonheim](https://runescape.wikia.com/wiki/Daemonheim).\n\nThere are 26 combination potions in total. All of them need to be unlocked by purchasing the recipe from the Recipe Shop in Meilyr Clan district, with prices from 100,000 coins to 1,000,000 coins, and nine have the additional requirement of finding unreadable pages in Daemonheim first. Buying all recipes will cost the player a total of 11,500,000 coins.\n\nAn unreadable page is a lost text containing recipes for the [Meilyr Clan](https://runescape.wikia.com/wiki/Meilyr_Clan) in [Prifddinas](https://runescape.wikia.com/wiki/Prifddinas). It can be found within Daemonheim on any floor at any complexity (even on free worlds), or received from the [Motherlode Maw](https://runescape.wikia.com/wiki/Motherlode_Maw). [Hard mode](https://runescape.wikia.com/wiki/Dungeoneering/Hard_mode) floors will increase the chances of a page appearing however, there is no guarantee that a page will be found on any floor. A [perfect juju herblore potion](https://runescape.wikia.com/wiki/Perfect_juju_herblore_potion) will increase the chance of finding a page by 10%, and a [perfect juju dungeoneering potion](https://runescape.wikia.com/wiki/Dungeoneering/Hard_mode) can also increase the chance. A page is a guaranteed find with a [Consistent yak solo](https://runescape.wikia.com/wiki/Consistent_yak_card_(solo) / [team card](https://runescape.wikia.com/wiki/Consistent_yak_card_(team) obtained from [Gorajo hoardstalker](https://runescape.wikia.com/wiki/Gorajo_hoardstalker).",
			"thumbnail": {
				"url": "https://i.imgur.com/Shmagnp.png"
			},
			"fields": [
	...
	"seren memories": {
		...
		"embed": {
			...
			"description": "[Seren Memories](http://runescape.wikia.com/wiki/Seren_Memories) is an achievement that requires the player to find all four of [Seren's memoriam crystals](https://runescape.wikia.com/wiki/Memoriam_crystal#Seren.27s_Memories) and claim the [Crest of Seren](https://runescape.wikia.com/wiki/Crest_of_Seren_(override) override on [Freneskae](https://runescape.wikia.com/wiki/Freneskae).\n\nThe four Seren crystals can be found in a special area in [The Approach](https://runescape.wikia.com/wiki/Freneskae#The_Approach), which cannot be reached until [Fate of the Gods](https://runescape.wikia.com/wiki/Fate_of_the_Gods) has been completed, since a bridge is formed when a pillar is knocked over by [Mah](https://runescape.wikia.com/wiki/Mah)'s awakening.\n\nThe frequency of lightning strikes increase as more crystals are tagged: it is recommended to take plenty of high-leveled [food](https://runescape.wikia.com/wiki/Food), and possibly a [beast of burden](https://runescape.wikia.com/wiki/Beast_of_Burden). Consider wearing your best [tank armour](https://runescape.wikia.com/wiki/Category:Tank_armour) and using [life point](https://runescape.wikia.com/wiki/Life_points) boosts. [Defenders](https://runescape.wikia.com/wiki/Defender), and a [Leviathan rings](https://runescape.wikia.com/wiki/Leviathan_ring) also have a chance to negate some of the damage taken. Having the [Distorted engrammeter](https://runescape.wikia.com/wiki/Distorted_engrammeter) in your inventory also reduces damage taken from lightning strikes.\n\nOnce all crystals have been unlocked, be sure to retrieve them from the stand in the eastern corner. Upon depositing the four crystals at [The Sanctum](https://runescape.wikia.com/wiki/Freneskae#The_Sanctum), a storage area will open. Searching the storage will reveal the Crest of Seren and unlock it as a cosmetic override in the head slot.\n\nNote: Leaving the area in any way (crossing the bridge, dying, logging out, or teleporting) will reset the count, but not the retrieved crystals.",
			"thumbnail": {
				"url": "https://i.imgur.com/Shmagnp.png"
			},
			"fields": [
				...
				},
				{
					...
					"value": "• **Memoriam Crystal:** [01](https://runescape.wikia.com/wiki/Memoriam_crystal_s01)\n\t• **Story:** Memos of the Light: Mother\n\n• **Memoriam Crystal:** [02](https://runescape.wikia.com/wiki/Memoriam_crystal_s02)\n\t• **Story:** Memos of the Light: Dream\n\n• **Memoriam Crystal:** [03](https://runescape.wikia.com/wiki/Memoriam_crystal_s03)\n\t• **Story:** Memos of the Light: Nightmares\n\n• **Memoriam Crystal:** [04](https://runescape.wikia.com/wiki/Memoriam_crystal_s04)\n\t• **Story:** Memos of the Light: Peace"
				},
				{
					"name": "Requirements:",
					"value": "• Fate of the Gods Quest completion | [Runescape Wiki](http://runescape.wikia.com/wiki/Fate_of_the_Gods)"
	...
	"shadows below": {
		...
		"embed": {
            ...
            "description": "[Shadows Below](https://runescape.wikia.com/wiki/Shadows_Below) is is an achievement that requires the player to defeat the [Barrows: Rise of the Six](https://runescape.wikia.com/wiki/Barrows:_Rise_of_the_Six). Players may request free assistance for this kill utilizing the <#436714722847621120> channel.",
            "thumbnail": {
                "url": "https://i.imgur.com/Shmagnp.png"
            },
            "fields": [
	...
	"sing for the lady": {
		...
		"embed": {
			...
			"description": "[Sing for the Lady](http://runescape.wikia.com/wiki/Sing_for_the_Lady) is an achievement that requires the player to claim the [magic XP lamp](https://runescape.wikia.com/wiki/Magic_XP_lamp) from [Lady Ithell](https://runescape.wikia.com/wiki/Lady_Ithell) by giving her a [crystal staff](https://runescape.wikia.com/wiki/Crystal_staff), [crystal orb](https://runescape.wikia.com/wiki/Crystal_orb), [crystal wand](https://runescape.wikia.com/wiki/Crystal_wand), and [crystal ward](https://runescape.wikia.com/wiki/Crystal_ward). All of these items may be obtained from the Grand Exchange.",
			"thumbnail": {
				"url": "https://i.imgur.com/Shmagnp.png"
			},
			"fields": [
	...
	"slayer master": {
		...
		"embed": {
			...
			"description": "[Slayer Master](http://runescape.wikia.com/wiki/Slayer_Master_(achievement%29) is an achievement that requires the player to complete wave twenty of the [platinum difficulty](https://runescape.wikia.com/wiki/Rush_of_Blood#Platinum) of [Rush of Blood](https://runescape.wikia.com/wiki/Rush_of_Blood) and earning the title `Slayer Master [Name]`. Twenty waves need to be cleared, reaching wave 20 does not suffice.\n\nThe title can be unlocked on either a reward or trial run. If any of the previous titles (`the Abyssal`, `the Dark`, and `the Beast`) weren't unlocked yet, then those will be unlocked at the same time.\n\nRush of Blood is a weekly Slayer-themed combat [Distraction and Diversion](https://runescape.wikia.com/wiki/Distractions_and_Diversions) that can be played in [Prifddinas](https://runescape.wikia.com/wiki/Prifddinas). It is run by Morvran Iorwerth, slayer master and former warband leader, and takes place in [his dungeon](https://runescape.wikia.com/wiki/Morvran%27s_Dungeon) underneath the [Iorwerth Clan](https://runescape.wikia.com/wiki/Iorwerth_Clan) district. In the D&D, waves of different monsters, drawn from Morvran's assignment list, must be fought and one is given ten minutes to do so.\n\nThe timer does not begin until the player passes the barrier. A bank chest is available just outside of the arena, and can be accessed at any time. Doing so will not pause the timer. This means that use of the chest should be judged wisely.\n\n Players may utilize the [Rush of blood damage enhancer](https://runescape.wikia.com/wiki/Rush_of_blood_damage_enhancer), which gives a 10% damage boost.",
			"thumbnail": {
				"url": "https://i.imgur.com/Shmagnp.png"
			},
			"fields": [
				...
				{
					"name": "​",
					"value": "• Ability to kill [Ice Strykwyrms](https://runescape.wikia.com/wiki/Ice_strykewyrm) by:\n\t• Wearing a [Fire cape](https://runescape.wikia.com/wiki/Fire_cape)\n\t• Wearing a [TokHaar-Kal cape](https://runescape.wikia.com/wiki/TokHaar-Kal)\n\t• Wearing a [Completionist cape](https://runescape.wikia.com/wiki/Completionist_cape)\n\t\tor\n\t• Having purchased the ability to fight them with 2,000 [slayer points](https://runescape.wikia.com/wiki/Slayer_reward_point)"
				},
				{
					"name": "Guide:",
					"value": "[Updated Rush of Blood Guide | The Junesong - YouTube](https://www.youtube.com/watch?v=l5jz9ybmg-U)"
