exports.run = async (client, message, args, level) => {
    ...
    "embed": {
      ...
      "description": "\nIf you are looking to complete the 139 new achievements released in the Achievement Bonanza update and bump up your RuneScore, check out [this page](https://runescape.wiki/w/User:Salix_of_Prifddinas/Achievement_Bonanza) on the RuneScape Wiki for a list of them all.\n\nAll thanks to <@220616902857195521>!",
      "color": 2927667,
      "footer": {
