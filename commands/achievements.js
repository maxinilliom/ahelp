exports.run = async (client, message, args, level) => {
    ...
    "embed": {
      ...
      "description": "If you are looking to complete the 139 new achievements released in the Achievement Bonanza update and bump up your RuneScore, check out [this page]() on the RuneScape Wiki for a list of them all.\n\nAll thanks to <@>!",
      "color": 2927667,
      "footer": {
